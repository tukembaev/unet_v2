...
export const Institute = () => {
  ...
  const { data: institutionsKpiReport } = useKpiInstitutionReport();
  ...
  return (
    <div className="p-4 flex flex-wrap gap-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-sm font-semibold">{item?.title_faculty}</h3>
              </div>
        ...
        : <DepartmentsKpiReports id={selectedInstitute!}/>}
    </div>
  );
};
