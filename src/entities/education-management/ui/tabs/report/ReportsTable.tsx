...
export const ReportsTable = ({ data }: ReportsTableProps) => {
  ...
  const filteredData = useMemo(() => {
    ...
    return data.map(institute => ({
      ...institute,
      syllabuses: institute.syllabuses.filter(syllabus => 
        syllabus.direction.toLowerCase().includes(searchQuery.toLowerCase()) ||
        syllabus.profile.toLowerCase().includes(searchQuery.toLowerCase()) ||
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-gray-50">
                  ...
                  <TableHead className="text-center font-bold">Профиль</TableHead>
                  <TableHead className="text-center font-bold">Длит.обучения</TableHead>
                  <TableHead className="text-center font-bold">Годы обучения</TableHead>
                  <TableHead className="text-center font-bold">Кл.Семестров</TableHead>
                  <TableHead className="text-center font-bold">Кл.Предметов</TableHead>
                  <TableHead className="text-center font-bold">Скачать Excel</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
